...
namespace Horror
{
    public class SoundEmitterVault
    {
        ...
        public AudioSignalKey GetKey(AudioSignalSO cue)
        {
            return new AudioSignalKey(_nextUniqueKey++, cue);
        }
        ...
        public AudioSignalKey Add(AudioSignalSO cue, SoundEmitter[] emitter)
        {
            AudioSignalKey emitterKey = GetKey(cue);
